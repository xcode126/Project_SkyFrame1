package com.sky.skyframe1.widget;
...
public class TabRadioGroup extends LinearLayout {
     ...
     * @attr ref android.R.styleable#TabRadioGroupextends_checkedButton
     * @see #check(int)
     * @see #clearCheck()
     */
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(TabRadioGroup.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(TabRadioGroup.class.getName());
    }
     ...
     * <p/>
     * <p>
     * See {@link //android.R.styleable#LinearLayout_Layout LinearLayout Attributes} for a
     * list
